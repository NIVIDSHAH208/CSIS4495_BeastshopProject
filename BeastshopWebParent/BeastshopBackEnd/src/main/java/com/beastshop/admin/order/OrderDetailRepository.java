...
public interface OrderDetailRepository extends CrudRepository<OrderDetail, Integer> {
	...
	@Query("SELECT NEW com.beastshop.common.entity.order.OrderDetail(d.product.category.name, d.quantity, d.productCost, d.shippingCost, d.subtotal) "+
	...
	@Query("SELECT NEW com.beastshop.common.entity.order.OrderDetail(d.quantity, d.product.name, d.productCost, d.shippingCost, d.subtotal) "+
			"FROM OrderDetail d WHERE d.order.orderTime BETWEEN ?1 AND ?2")
