...
public interface OrderRepository extends PagingAndSortingRepository<Order, Integer> {
	...
	@Query("SELECT o FROM Order o WHERE CONCAT('#', o.id) LIKE %?1% OR CONCAT(o.firstName, ' ', o.lastName) LIKE %?1% OR o.firstName LIKE %?1% OR " + "o.lastName LIKE %?1% OR o.phoneNumber LIKE %?1% OR "
